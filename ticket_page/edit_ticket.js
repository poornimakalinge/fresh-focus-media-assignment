$(document).ready(function()
{
    ...
    // When Staff dropdown changes
    $(document).on('change', '#labour_staff', function()
    {
    ...
    // When Positions dropdown changes
    $(document).on('change', '#labour_position', function()
    {
        var $parentRow = $(this).closest('.labour-item-row');
        clearLablourRates($parentRow);
    ...
    //when labour uom changes
    $(document).on('change', '#labour_uom', function()
    {
        var $parentRow = $(this).closest('.labour-item-row');
    ...
    // When Trucks dropdown changes
    $(document).on('change', '#truck_label', function()
    {
    ...
    //when truck uom changes
    $(document).on('change', '#truck_uom', function()
    {
        var $parentRow = $(this).closest('.truck-item-row');
        var uom_id = $(this).find('option:selected').attr('id');
        if(uom_id){
    ...
    // Add labour row
    $(document).on('click', '#labour_add', function() {
    ...
    //  Remove labour row
    $(document).on('click', '#labour_remove', function() {
    ...
    //  Remove truck row
    $(document).on('click', '#truck_remove', function() {
        $(this).closest('.truck-item-row').remove();
    });

    // Add miscellaneous row
    $(document).on('click', '#miscell_add', function() {
    ...
    $(document).on('click', '#miscell_remove', function() {
        $(this).closest('.miscell-item-row').remove();
    });

    // Event listener for reg hours and overtime inputs changes
    $(document).on('change', '#labour_reg_hours, #labour_overtime', function() {
        calculateLabourSubtotal();
    });
    // Event listener for truck Quantity
    $(document).on('change', '#truck_qty', function() {
        calculateTruckSubtotal();
    });
    // Event listener for reg hours and overtime inputs changes
    $(document).on('change', '#miscell_cost, #miscell_price, #miscell_qty', function() {
    ...
    $('#submit_field_ticket_form').click(function() {
